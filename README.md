...
| **Customer** | `customer` | `hi2000pass` | **Customer access**: Browse/search products (read-only), create orders, reserve stock, and cancel orders. Cannot modify products (returns `403 Forbidden`). |
